...
LIBALU_SO_OBJECTS:=$(PRJ_LIB_OBJ_FILES:%=%$(PRJ_SFX).o)
LIBALU_DLL_OBJECTS:=$(PRJ_LIB_OBJ_FILES:%=%$(PRJ_SFX).obj)
LIBALU_32DLL_OBJECTS:=$(PRJ_LIB_OBJ_FILES:%=%$(PRJ_SFX).32.obj)
LIBALU_64DLL_OBJECTS:=$(PRJ_LIB_OBJ_FILES:%=%$(PRJ_SFX).64.obj)
